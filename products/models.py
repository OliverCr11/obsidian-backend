...
class Glove(models.Model):
    ...
    is_hero_drop = models.BooleanField(default=False)
    hero_title_over_the_product = models.CharField(max_length=150, blank=True, null=True, help_text='e.g., LA SEGUNDA PIEL. LOTE 001.')
    hero_marketing_description = models.TextField(blank=True, null=True)
    limited_drop_info_text = models.CharField(max_length=100, blank=True, null=True, help_text='e.g., Strictly limited to 50 pairs.')
    countdown_target_date = models.DateTimeField(null=True, blank=True)
    created_at = models.DateTimeField(auto_now_add=True)
